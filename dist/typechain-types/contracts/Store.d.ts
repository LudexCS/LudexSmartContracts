...
export interface StoreInterface extends Interface {
    ...
    encodeFunctionData(functionFragment: "purchaseItemWithPermission", values: [
        BigNumberish,
        AddressLike,
        BigNumberish,
        BigNumberish,
...
export declare namespace ItemPurchasedEvent {
    type InputTuple = [
        itemID: BigNumberish,
        buyer: AddressLike,
        tokenID: BigNumberish
    ];
    type OutputTuple = [itemID: bigint, buyer: string, tokenID: bigint];
...
export interface Store extends BaseContract {
    ...
    getFunction(nameOrSignature: "isTokenPermitted"): TypedContractMethod<[token: AddressLike], [boolean], "view">;
    ...
    getFunction(nameOrSignature: "ledger"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "owner"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "payment"): TypedContractMethod<[], [string], "view">;
    ...
    getFunction(nameOrSignature: "purchaseItemWithPermission"): TypedContractMethod<[
        itemID: BigNumberish,
        token: AddressLike,
        deadline: BigNumberish,
        v: BigNumberish,
    ...
    filters: {
        "ItemPurchased(uint32,address,uint256)": TypedContractEvent<ItemPurchasedEvent.InputTuple, ItemPurchasedEvent.OutputTuple, ItemPurchasedEvent.OutputObject>;
