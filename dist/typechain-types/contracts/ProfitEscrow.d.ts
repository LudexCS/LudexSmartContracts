...
export interface ProfitEscrowInterface extends Interface {
    getFunction(nameOrSignature: "accumulate" | "claim" | "getBalanceFor" | "isTrustedForwarder" | "itemRegistry" | "owner" | "paymentProcessor" | "priceTable" | "renounceOwnership" | "setPaymentProcessor" | "transferOwnership" | "trustedForwarder"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "OwnershipTransferred" | "ProcessorUpdated" | "ProfitAccumulated" | "ProfitClaimed"): EventFragment;
