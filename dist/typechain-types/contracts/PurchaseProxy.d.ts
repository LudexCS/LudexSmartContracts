...
export interface PurchaseProxyInterface extends Interface {
    getFunction(nameOrSignature: "claimPurchaseIDs" | "owner(uint32,uint256)" | "owner()" | "purchaseItem" | "renounceOwnership" | "transferOwnership"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "OwnershipTransferred"): EventFragment;
    encodeFunctionData(functionFragment: "claimPurchaseIDs", values: [BigNumberish, AddressLike, AddressLike]): string;
    encodeFunctionData(functionFragment: "owner(uint32,uint256)", values: [BigNumberish, BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "owner(uint32,uint256)", data: BytesLike): Result;
...
export interface PurchaseProxy extends BaseContract {
    ...
    getFunction(nameOrSignature: "owner(uint32,uint256)"): TypedContractMethod<[
        arg0: BigNumberish,
        arg1: BigNumberish
    ], [
        bigint
