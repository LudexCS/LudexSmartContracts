...
export interface SellerRegistryInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "addPaymentChannels",
    values: [AddressLike[]]
  ): string;
  encodeFunctionData(
    functionFragment: "isActiveSeller",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "removePaymentChannels",
    values: [AddressLike[]]
  ): string;
  encodeFunctionData(
...
export namespace PaymentChannelsAddedEvent {
  export type InputTuple = [
    seller: AddressLike,
    paymentChannels: AddressLike[]
  ];
  export type OutputTuple = [seller: string, paymentChannels: string[]];
  export interface OutputObject {
    seller: string;
...
export namespace PaymentChannelsRemovedEvent {
  export type InputTuple = [
    seller: AddressLike,
    paymentChannels: AddressLike[]
  ];
...
export interface SellerRegistry extends BaseContract {
  ...
  getFunction(
    nameOrSignature: "addPaymentChannels"
  ): TypedContractMethod<
    [paymentChannels_: AddressLike[]],
    [void],
    "nonpayable"
  >;
  getFunction(
    nameOrSignature: "isActiveSeller"
  ...
  >;
  getFunction(
    nameOrSignature: "removePaymentChannels"
  ): TypedContractMethod<
    [paymentChannels_: AddressLike[]],
    [void],
    "nonpayable"
  ...
  >;
  getEvent(
    key: "PaymentChannelsAdded"
  ): TypedContractEvent<
    PaymentChannelsAddedEvent.InputTuple,
    PaymentChannelsAddedEvent.OutputTuple,
    PaymentChannelsAddedEvent.OutputObject
  >;
  getEvent(
    key: "PaymentChannelsRemoved"
  ): TypedContractEvent<
    PaymentChannelsRemovedEvent.InputTuple,
    PaymentChannelsRemovedEvent.OutputTuple,
    PaymentChannelsRemovedEvent.OutputObject
  >;
  getEvent(
  ...
  filters: {
    ...
    "PaymentChannelsAdded(address,address[])": TypedContractEvent<
      PaymentChannelsAddedEvent.InputTuple,
      PaymentChannelsAddedEvent.OutputTuple,
      PaymentChannelsAddedEvent.OutputObject
    >;
    PaymentChannelsAdded: TypedContractEvent<
      PaymentChannelsAddedEvent.InputTuple,
      PaymentChannelsAddedEvent.OutputTuple,
      PaymentChannelsAddedEvent.OutputObject
    >;

    "PaymentChannelsRemoved(address,address[])": TypedContractEvent<
      PaymentChannelsRemovedEvent.InputTuple,
      PaymentChannelsRemovedEvent.OutputTuple,
      PaymentChannelsRemovedEvent.OutputObject
    >;
    PaymentChannelsRemoved: TypedContractEvent<
      PaymentChannelsRemovedEvent.InputTuple,
      PaymentChannelsRemovedEvent.OutputTuple,
      PaymentChannelsRemovedEvent.OutputObject
    >;

    "SellerRegistered(address,address[],bool)": TypedContractEvent<
      SellerRegisteredEvent.InputTuple,
      SellerRegisteredEvent.OutputTuple,
      SellerRegisteredEvent.OutputObject
    >;
