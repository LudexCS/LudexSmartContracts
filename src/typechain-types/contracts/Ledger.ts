...
export interface LedgerInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "getPurchaseID",
...
export interface Ledger extends BaseContract {
  ...
  getPurchaseID: TypedContractMethod<
    [buyer: AddressLike, itemID: BigNumberish, timestamp: BigNumberish],
    [bigint],
    "view"
  >;
  ...
  logPurchase: TypedContractMethod<
    [itemID: BigNumberish, buyer: AddressLike],
    [bigint],
    "nonpayable"
  >;
