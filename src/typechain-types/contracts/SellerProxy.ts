...
export interface SellerProxyInterface extends Interface {
  ...
  getEvent(
    nameOrSignatureOrTopic:
      | "ItemRegistrationDelegated"
      | "OwnershipTransferred"
      | "ProfitClaimDelegated"
      | "SellerRightClaimed"
  ): EventFragment;
...
export namespace ProfitClaimDelegatedEvent {
  export type InputTuple = [
    token: AddressLike,
...
export namespace SellerRightClaimedEvent {
  export type InputTuple = [
    sellerID: BigNumberish,
...
export interface SellerProxy extends BaseContract {
  ...
  changeItemPrice: TypedContractMethod<
    [sellerID: BigNumberish, itemID: BigNumberish, newUsdPrice: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  claimSellerRight: TypedContractMethod<
    [sellerID: BigNumberish, items: BigNumberish[], sellerAddress: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "claimSellerRight"
  ): TypedContractMethod<
    [sellerID: BigNumberish, items: BigNumberish[], sellerAddress: AddressLike],
    [void],
    "nonpayable"
  ...
  ): TypedContractMethod<[sellerID: BigNumberish], [bigint[]], "view">;
  getFunction(
  ...
  >;
  getEvent(
    key: "SellerRightClaimed"
  ): TypedContractEvent<
    SellerRightClaimedEvent.InputTuple,
    SellerRightClaimedEvent.OutputTuple,
    SellerRightClaimedEvent.OutputObject
  >;
  ...
  filters: {
    "ItemRegistrationDelegated(uint32,uint32,uint32[])": TypedContractEvent<
      ...
      ItemRegistrationDelegatedEvent.OutputObject
    >;
    ItemRegistrationDelegated: TypedContractEvent<
      ItemRegistrationDelegatedEvent.InputTuple,
      ItemRegistrationDelegatedEvent.OutputTuple,
      ItemRegistrationDelegatedEvent.OutputObject
    >;
    ...
    "ProfitClaimDelegated(address,address,uint32)": TypedContractEvent<
      ...
      ProfitClaimDelegatedEvent.OutputObject
    >;
    ProfitClaimDelegated: TypedContractEvent<
      ProfitClaimDelegatedEvent.InputTuple,
      ProfitClaimDelegatedEvent.OutputTuple,
      ProfitClaimDelegatedEvent.OutputObject
    >;

    "SellerRightClaimed(uint32,address,uint32[])": TypedContractEvent<
      SellerRightClaimedEvent.InputTuple,
      SellerRightClaimedEvent.OutputTuple,
      SellerRightClaimedEvent.OutputObject
    >;
    SellerRightClaimed: TypedContractEvent<
      SellerRightClaimedEvent.InputTuple,
      SellerRightClaimedEvent.OutputTuple,
      SellerRightClaimedEvent.OutputObject
    >;
